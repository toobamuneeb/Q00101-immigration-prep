...
async function listPdfFields(pdfPath, outputJson = false) {
    try {
        // Read the PDF file
        const pdfBytes = (0, fs_1.readFileSync)(pdfPath);
        ...
        if (outputJson) {
            ...
            (0, fs_1.writeFileSync)(outputPath, JSON.stringify(jsonOutput, null, 2));
...
const pdfPath = (0, path_1.resolve)(args[0]);
