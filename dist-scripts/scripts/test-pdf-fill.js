...
const fill_pdf_1 = require("@/lib/pdf/fill-pdf");
...
async function testPDFFill(formId = "i-130") {
    ...
    try {
        ...
        const pdfBytes = await (0, fill_pdf_1.fillPDF)(formId, sampleAnswers);
        // Save to output directory
        const outputDir = (0, path_1.join)(process.cwd(), "output");
        const outputPath = (0, path_1.join)(outputDir, `${formId}-test-filled.pdf`);
