        ...
        <section className="mb-8 sm:mb-12">
          <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 shadow-lg">
            <CardHeader className="text-center">
              <CardTitle className="text-xl sm:text-2xl md:text-3xl text-slate-900">{t("pricing.title")}</CardTitle>
              <CardDescription className="text-sm sm:text-base md:text-lg mt-2 text-slate-700">
                {t("pricing.subtitle")}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 max-w-4xl mx-auto">
                <div className="text-center p-3 sm:p-6 bg-white rounded-xl shadow-md border-2 border-slate-200">
                  <div className="text-2xl sm:text-4xl font-bold text-[rgb(0,102,204)] mb-1 sm:mb-2">$70</div>
                  <div className="text-xs sm:text-sm text-slate-600 font-medium">
                    {t("pricing.oneForm")}
                  </div>
                </div>
                <div className="text-center p-3 sm:p-6 bg-white rounded-xl shadow-md border-2 border-green-200">
                  <div className="text-2xl sm:text-4xl font-bold text-[rgb(0,102,204)] mb-1 sm:mb-2">$120</div>
                ...
                <div className="text-center p-3 sm:p-6 bg-white rounded-xl shadow-md border-2 border-green-200">
                  <div className="text-2xl sm:text-4xl font-bold text-[rgb(0,102,204)] mb-1 sm:mb-2">$170</div>
                  <div className="text-xs sm:text-sm text-slate-600 font-medium mb-1">
                ...
                <div className="text-center p-3 sm:p-6 bg-white rounded-xl shadow-md border-2 border-green-200">
                  <div className="text-2xl sm:text-4xl font-bold text-[rgb(0,102,204)] mb-1 sm:mb-2">$240</div>
                  <div className="text-xs sm:text-sm text-slate-600 font-medium mb-1">
