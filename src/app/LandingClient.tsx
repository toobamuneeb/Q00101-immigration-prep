    ...
    <>
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href="/browse">
              <Button
                size="lg"
                className="text-lg px-10 py-7 bg-blue-600 hover:bg-blue-700 shadow-lg"
              >
                {t("getStarted")}
              </Button>
            </Link>
      ...
      <section className="relative py-24 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/browse">
              <Button
                size="lg"
                variant="secondary"
                className="text-lg px-10 py-7 bg-white text-blue-600 hover:bg-gray-100 shadow-xl font-semibold"
              >
                {t("browseAllForms")}
              </Button>
            </Link>
          ...
          <p className="mt-10 text-blue-200 text-sm">{t("ctaBenefits")}</p>
        </div>
      </section>
