...
const I485_DEFINITION: FormDefinition = {
  ...
  sections: [
    // PART 1: Information About You
    {
      ...
      questions: [
        ...
        },
        {
          ...
          type: "radio",
          label: "2. Have you ever used other names since birth?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        },
        {
          ...
          type: "text",
          label: "4. Alien Registration Number (A-Number) (if any)",
          placeholder: "A-",
        },
        {
          id: "part1.sex",
    ...
    },
    {
      ...
      description: "Provide your current U.S. address",
      questions: [
        {
    ...
    {
      id: "part1-immigration-history",
      title: "Part 1: Recent Immigration History",
      description: "Information about your most recent entry to the U.S.",
      questions: [
        {
        ...
        },
        {
          id: "part1.visaNumber",
          type: "text",
          label: "Nonimmigrant Visa Number Used During Most Recent Arrival",
        },
        {
        ...
        },
        {
          id: "part1.entryCity",
          type: "text",
          label: "Place of Last Arrival - City or Town",
          required: true,
        },
        {
          id: "part1.entryState",
          type: "text",
          label: "Place of Last Arrival - State",
          required: true,
        },
        {
          id: "part1.inspected",
          type: "radio",
          label: "When I last arrived in the United States:",
          required: true,
          options: [
            {
              value: "inspected",
              label: "I was inspected at a Port of Entry and admitted",
            },
            {
              value: "paroled",
              label: "I was inspected at a Port of Entry and paroled",
            },
            {
              value: "without",
              label:
        ...
        },
        {
          ...
          type: "text",
          label: "Immigration Status on Form I-94",
        },
        {
    ...
    // PART 2: Application Type
    {
      ...
      description: "Select your basis for applying for adjustment of status",
      questions: [
        {
          id: "part2.filingCategory",
          type: "select",
          label: "I am applying based on the following category:",
          required: true,
          options: [
            {
              value: "family-immediate",
              label: "Immediate relative of a U.S. citizen",
            },
            {
              value: "family-preference",
              label: "Family-based preference category",
            },
            {
              value: "employment-eb1",
              label: "Employment-based: EB-1 (Extraordinary Ability)",
            },
            {
              value: "employment-eb2",
              label: "Employment-based: EB-2 (Advanced Degree)",
            },
            {
              value: "employment-eb3",
              label: "Employment-based: EB-3 (Skilled Worker)",
            },
            { value: "asylee", label: "Asylee" },
            { value: "refugee", label: "Refugee" },
            { value: "diversity", label: "Diversity Visa program" },
        ...
        },
        {
          ...
          type: "radio",
          label: "Are you applying for adjustment based on INA section 245(i)?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        {
          id: "part2.principalDerivative",
          type: "radio",
          label: "I am filing this Form I-485 as a:",
          required: true,
          options: [
            { value: "principal", label: "Principal Applicant" },
            { value: "derivative", label: "Derivative Applicant" },
          ],
        },
      ],
    },
    ...
    {
      id: "part3-affidavit-exemption",
      title: "Part 3: Request for Exemption from Affidavit of Support",
      description: "Select if you are exempt from submitting Form I-864",
      questions: [
        {
          id: "part3.exemption",
          type: "select",
          label: "I am requesting an exemption because:",
          required: true,
          options: [
            {
              value: "40-quarters",
              label: "I have earned 40 qualifying quarters of work",
            },
            {
              value: "child-under-18",
              label:
                "I am under 18 years of age, unmarried child of U.S. citizen",
            },
            {
              value: "widow",
              label: "I am applying as widow(er) of a U.S. citizen",
            },
            { value: "vawa", label: "I am applying as a VAWA self-petitioner" },
            { value: "none", label: "None of these exemptions apply to me" },
          ],
        },
      ],
    },
    // PART 4: Additional Information
    {
      ...
      description: "Your employment, education, and previous applications",
      questions: [
        {
          id: "part4.appliedImmigrantVisa",
          type: "radio",
          label:
            "Have you ever applied for an immigrant visa at a U.S. Embassy or Consulate?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        {
          id: "part4.appliedPermanentResidence",
          type: "radio",
          label:
        ...
        {
          id: "part4.employmentHistory",
          type: "textarea",
          label: "Employment and Educational History (last 5 years)",
          placeholder: "List employers, schools, dates, and addresses",
          helpText:
            "Include periods of self-employment, unemployment, or retirement",
        },
      ],
    },
    // PART 5: Parents Information
    {
      id: "part5-parents",
      title: "Part 5: Information About Your Parents",
    ...
    {
      id: "part6-marital",
      title: "Part 6: Information About Your Marital History",
      description: "Current and previous marriage information",
      questions: [
        {
    ...
    // PART 7: Children Information
    {
      id: "part7-children",
      title: "Part 7: Information About Your Children",
      description: "Information about all your living children",
      questions: [
        {
          id: "part6.totalChildren",
          type: "text",
          label: "Total number of ALL living children anywhere in the world",
          required: true,
          placeholder: "Enter number",
          helpText:
            "Includes adult sons and daughters, stepchildren, adopted children",
        },
        {
          id: "part6.childrenDetails",
          type: "textarea",
          label: "Provide details for each child",
          placeholder:
            "For each child: Name, Date of Birth, Country of Birth, Relationship",
          helpText: "Include biological, adopted, and stepchildren of any age",
        },
      ],
    },
    ...
    // PART 9: General Eligibility and Inadmissibility
    {
      id: "part9-eligibility",
      title: "Part 9: General Eligibility and Inadmissibility Grounds",
      description: "Answer these important questions about your background",
      questions: [
        {
          id: "part8.organizations",
          type: "radio",
          label:
            "Have you EVER been a member of or associated with any organization?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
          ...
          helpText:
            "Includes political, social, religious, or any other organizations",
        },
        {
          id: "part8.criminalHistory",
          type: "radio",
          label: "Have you EVER been arrested, cited, charged, or detained?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        },
        {
          ...
          type: "radio",
          label: "Have you EVER violated any controlled substance law?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        },
        {
          ...
          type: "radio",
          label: "Have you EVER trafficked in persons?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        },
        {
          ...
          type: "radio",
          label: "Have you EVER engaged in terrorist activity?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        },
        {
          id: "part8.torture",
          type: "radio",
          label: "Have you EVER ordered, incited, or participated in torture?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        },
        {
          id: "part8.genocide",
          type: "radio",
          label: "Have you EVER ordered, incited, or participated in genocide?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        },
        {
          ...
          type: "radio",
          label: "Have you EVER used children under 15 in hostilities?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        },
        {
          ...
          type: "radio",
          label: "Have you EVER enforced violations of religious freedoms?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        },
        {
          ...
          type: "radio",
          label: "Have you EVER submitted fraudulent documents to USCIS?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        },
        {
          ...
          type: "radio",
          label: "Have you EVER voted in violation of U.S. law?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        },
        {
          id: "part8.renounced",
          type: "radio",
          label: "Have you EVER renounced U.S. citizenship to avoid taxes?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        },
        {
          ...
          type: "radio",
          label: "Have you been unlawfully present in the United States?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
        ...
        },
        {
          ...
          type: "radio",
          label: "Are you subject to public charge grounds of inadmissibility?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
    ...
    // PART 10: Contact Information and Signature
    {
      id: "part10-signature",
      title: "Part 10: Contact Information, Certification, and Signature",
      description: "Your contact information and signature",
      questions: [
        {
        ...
        {
          id: "part10.certification",
          type: "checkbox",
          label:
            "I certify, under penalty of perjury, that all information provided is complete, true, and correct",
          required: true,
        },
      ],
    },
    // PART 14: Additional Information
    {
      ...
      questions: [
        {
          id: "part14.additionalInfo",
          type: "textarea",
          label: "Additional Information",
          placeholder: "Provide any additional information here",
          helpText:
            "Use this space for explanations, additional addresses, employment history, etc.",
        },
      ],
    },
  ],
  // Keep your existing pdfFieldMappings (they're comprehensive and correct)
  pdfFieldMappings: [
    // ==================== PART 1: Information About You ====================
  ...
  instructions: [
    ...
    "Submit with the correct filing fee",
  ],
};
  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          type: "radio",
          label:
            "9. Has your name legally changed since you were granted lawful permanent residence?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          type: "radio",
          label:
            "13. Is your physical address the same as your mailing address?",
          required: true,
          options: [
            { value: "yes", label: "Yes" },
            { value: "no", label: "No" },
          ...
          options: [
            {
              value: "1a",
              label:
                "1.a. My existing card has been lost, stolen, or destroyed",
            },
            {
              value: "1b",
              label: "1.b. My previous card was issued but never received",
            },
            { value: "1c", label: "1.c. My existing card has been mutilated" },
            {
              value: "1d",
              label:
                "1.d. My existing card has incorrect data because of DHS error",
            },
            {
              value: "1e",
              label:
                "1.e. My name or other biographic information has been legally changed since issuance",
            },
            {
              value: "1f",
              label:
                "1.f. My card has already expired or will expire within 6 months",
            },
            {
              value: "1g",
              label: "1.g. I have reached my 14th birthday and am registering",
            },
            {
              value: "1h",
              label: "1.h. I am a commuter and need to replace my card",
            },
          ],
        },
      ],
      ...
      questions: [
        {
          ...
          options: [
            {
              value: "consular",
              label: "At a U.S. Embassy or Consulate (Consular Processing)",
            },
            {
              value: "adjustment",
              label: "Within the United States (Adjustment of Status)",
            },
          ],
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          type: "checkbox",
          label:
            "I am blind or have low vision and request materials in alternative format",
        },
        {
          id: "part5.4.other",
          type: "text",
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              value: "preparer",
              label: "An attorney or accredited representative prepared it",
            },
          ],
        },
      ],
      ...
      questions: [
        {
          ...
          type: "checkbox",
          label:
            "I certify, under penalty of perjury, that all information in this application and evidence submitted is true and correct",
          required: true,
        },
        {
          ...
          type: "checkbox",
          label:
            "I authorize release of information from this application to other government agencies",
          required: true,
        },
      ],
    },
