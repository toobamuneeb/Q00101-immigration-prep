...
exports.NEEDS_REVIEW_MAPPINGS = exports.HIGH_CONFIDENCE_MAPPINGS = exports.I_212_AUTO_MAPPINGS = void 0;
exports.I_212_AUTO_MAPPINGS = [
 ...
 * 0 mappings
 */
exports.HIGH_CONFIDENCE_MAPPINGS = exports.I_212_AUTO_MAPPINGS.filter((_, i) => {
 ...
 * 0 mappings
 */
exports.NEEDS_REVIEW_MAPPINGS = exports.I_212_AUTO_MAPPINGS.filter((_, i) => {
    const confidences = [10, 10];
