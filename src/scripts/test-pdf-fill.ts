...
const SAMPLE_DATA: Record<string, Record<string, any>> = {
  ...
  "i-9": {
    ...
    "preparer1.lastName": "Doe",
    "preparer1.firstName": "Jane",
    "preparer1.middleInitial": "E",
    "preparer1.streetAddress": "101 First Ave",
    "preparer1.city": "New York",
    "preparer1.state": "NY",
    "preparer1.zipCode": "10001",
    "preparer1.date": "2025-12-10",
    "preparer2.lastName": "Brown",
    "preparer2.firstName": "Alex",
    "preparer2.middleInitial": "J",
    "preparer2.streetAddress": "202 Second St",
    "preparer2.city": "Brooklyn",
    "preparer2.state": "NY",
    "preparer2.zipCode": "11201",
    "preparer2.date": "2025-12-11",
    "preparer3.lastName": "Lee",
    "preparer3.firstName": "Chris",
    "preparer3.middleInitial": "K",
    "preparer3.streetAddress": "303 Third Rd",
    "preparer3.city": "Queens",
    "preparer3.state": "NY",
    "preparer3.zipCode": "11368",
    "preparer3.date": "2025-12-12",
    "preparer4.lastName": "Garcia",
    "preparer4.firstName": "Maria",
    "preparer4.middleInitial": "L",
    "preparer4.streetAddress": "404 Fourth Blvd",
    "preparer4.city": "Bronx",
    "preparer4.state": "NY",
    "preparer4.zipCode": "10451",
    "preparer4.date": "2025-12-13"
  },
  "i-526": {
  ...
  "i-601": {
    ...
    "part3.extremeHardship":
      "Spouse has chronic medical condition requiring care",
  },
  "i-601a": {
    "part1.lastName": "Kim",
    "part1.firstName": "Soo",
